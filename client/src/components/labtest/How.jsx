...
const How = () => {
  return (
    <div className="flex flex-col justify-center m-auto items-center gap-10 lg:px-20 px-10 lg:pb-20 py-10">
      <h1 className="lg:text-2xl md:text-xl text-lg font-semibold">
        How it works?
      </h1>
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:w-[80%] gap-12 md:w-[100%] m-auto w-auto">
        {data.map((item, ind) => (
          <div key={ind} className="flex flex-row gap-5 shadow-xl p-5 rounded-2xl w-72">
            <img
              src={item.img}
              alt="img"
              className="w-16 h-16"
